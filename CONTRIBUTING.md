...
```
git remote add upstream https://github.com/captivators/feedpile.git
```
...
It is most wise to have a buddy give your changes a code review, and once
...
Thanks for contributing to Feedpile!
